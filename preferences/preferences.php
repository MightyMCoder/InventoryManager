 ...
 *
 * @param HtmlPage $page The page object where the preference panel will be added
 ...
 * @return void
 */
function addPreferencePanel(HtmlPage $page, string $id, string $title, string $icon, string $content): void
{
