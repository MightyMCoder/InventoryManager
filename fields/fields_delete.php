...
switch ($getMode) {
	case 1:
		...
		// show form
		$form = new HtmlForm('itemfield_delete_form', SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_PLUGINS . PLUGIN_FOLDER_IM . '/fields/fields_delete.php', array('imf_id' => $getimfId, 'mode' => 2)), $page);
