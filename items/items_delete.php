 ...
 * @param $authorizedForDelete
 * @throws AdmException
 * @throws SmartyException
 */
function displayItemDeleteForm(CItems $items, User $user, int $getItemId, bool $getItemFormer, $authorizedForDelete): void
{
 ...
 * @throws SmartyException
 */
function deleteItem(CItems $items, int $getItemId, int $gCurrentOrgId): void
{
 ...
 * @throws SmartyException
 */
function makeItemFormer(CItems $items, int $getItemId, int $gCurrentOrgId): void
{
    global $gMessage, $gNavigation, $gL10n;
 ...
 * @throws SmartyException
 */
function undoItemFormer(CItems $items, int $getItemId, int $gCurrentOrgId): void
{
    global $gMessage, $gNavigation, $gL10n;
